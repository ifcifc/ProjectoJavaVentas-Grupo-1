...
public abstract class BaseController extends HttpServlet {
     ...
     * busca un metodo que coincida con el nombre pasado por el accion y llamara
    ...
    /**
     * Este método es llamado cuando se recibe una solicitud a través de un
     * método específico. Busca en la clase un método que coincida con el nombre
     * pasado en el parámetro "accion". El metodo al que se llama debe de ser un
     * metodo publico. Si encuentra una coincidencia, invoca el método
     * correspondiente.
     *
     * @param request el objeto HttpServletRequest que contiene la información
     * de la solicitud del cliente
     * @param response el objeto HttpServletResponse para enviar la respuesta al
     * cliente
     * @param method_type un String que representa el tipo de método HTTP (por
    ...
    public void showMessage(HttpServletRequest request, HttpServletResponse response, String title, String message, String url) throws ServletException, IOException {
